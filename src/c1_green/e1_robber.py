...
def sc_thanksgod(w: World):
    ...
    return w.scene("神に感謝する",
            ...
            sky.look("見上げた空は雲が一つも浮かんでいない青一色で、そこを飛空する鳥も飛行機も、虫の一匹すら見つけられない",
                "僅かにグラデーションさせて塗り潰したＣＧみたいな整った配色だ","つまらないな、と心の中で呟き、耳に僅かに掛かる金髪を掻き上げて青年はペダルを漕いだ"),
            w.eventStart("電子世界"),
            w.eventPoint("電子世界", "オブジェクトの数が減らされている"),
            w.comment("タンペレは湖畔工業都市。北欧の夏と分かるように"),
            nocht.do("遊歩道をロードバイクで軽快に走るのが心地良い",
                "スカイブルーのシャツから出た前腕の白さが陽光に照らされ、その熱を風が浚っていく",
            ...
            nocht.do("交差点を渡り、車線の左側をするすると進んでいく",
                "途中で脇の路地に入り、やや下り坂になったところを一気に駆け下りた",
                "三十秒もせずに右手側に大きな駐車場とスーパーマーケットが見えてきて、",
                "入り口に立つ緑色の制服を着た警備員は$Sの姿に誘導棒を振る", "注意ではなく$frank流の挨拶だ"),
            _.do("その前の歩道を半裸のおじさんがウォッカ片手に歩き、",
                "必死に手押し車を握って歩く老婦人がその脇をするすると追い抜いていく",
...
def sc_robber(w: World):
    ...
    return w.scene("強盗",
            ...
            nocht.do("キャッシュレス化が進んでいるとはいえ、まだまだ現金が必要な場面が多い",
                ...
                "特別価格が安い訳ではないらしいがこの国のコンビニはとにかく割高で、余程の事情がない限りソーダ水一本すら買わない",
                "精々がＡＴＭを利用する時くらいだ"),
            inside.look("商品棚には歯ブラシやコップ、ロウソク、下着といった生活雑貨やスナック菓子、チョコレート、サルミアッキの缶等が並ぶほか、",
                ...
                "客は$S以外に腰の曲がったサンバイザーの老婦人と、レジ裏の棚を掃除しているお腹の大きな男性店員だけだ",
            ...
            oldlady.do("その音と衝撃に老婦人は腰を抜かし、床に転がった", "気づいた強盗は銃口の先を店員から彼女へ変更して「早く」と急かす"),
            nocht.do("$Sはシャツの下のロザリオを服の上から握り、小声で神に祈る",
                "いつもみたいに見守っていて下さい、と"),
            nocht.do("それから声を上げ、二リットルのボトルを手にして男に襲いかかった",
                "目出し帽は咄嗟に銃口を近づいてくる$Sへと向けたが、彼が引き金を引くよりもその頭部にボトルの縁が衝突する方が僅かに早い",
                "鈍い呻き声を上げ、巨漢が後ろのカウンターへと吹き飛んだ", "だがそれと同時に銃声が鳴った"),
            nocht.think("――あ、れ？"),
