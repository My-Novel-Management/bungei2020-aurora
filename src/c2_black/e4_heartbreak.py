...
def sc_confession(w: World):
    ...
    return w.scene("告白",
            ...
            erucco.be(),
            nocht.talk("終わりましたよ"),
            erucco.talk("珍しい時間に来るものだから何事かと思ったよ"),
            _.do("そう笑いかけながらも神父はリラックスした様子のままだ"),
            nocht.talk("あの、いいですか"),
            erucco.talk("そうかい", "分かったよ", "先に入って準備していてくれ"),
            _.do("神父は告解室に向かった$Sを見送りながら、台のところに隠してあった栄養ドリンクの小瓶を取り出し、それを煽った",
                "それから頭を二度、三度と振ると、ゆっくりとした足取りで$Sの入った対面の部屋のドアを開ける"),
            nocht.talk("神様に女心について尋ねるのもあれだが、どうだろう",
                "そろそろ関係を進展させる為の何かアクションが必要だと思うんだ"),
            erucco.talk("その前に、まず神の声にあなたの心を開いて下さいませんかね、$nochtさん"),
            nocht.talk("$meはいつだって神に対して心は全開だからいいんですよ",
                "それよりも、ここまで小さなやり取りを積み重ねてきてお互いの紹介は充分終わっていると思うんだ",
