...
def sc_nearwinter(w: World):
    ...
    return w.scene("秋のある日",
            ...
            nocht.do("自転車は軽快に路脇を走り抜け、同じような建物が並ぶのを視界に収めながら交差点を曲がる",
            ...
            nocht.do("胸ポケットに入れた端末が震え、何かメッセージを受け取ったことを知らせた",
                "速度を緩めて停止すると、慌てて確認する"),
            _.talk("$asahiからだ"),
            _.explain("彼女と出会ってから半年、ようやく最近になってフランクに言葉のやり取りができるようになってきたと$S自身は感じていた"),
...
def sc_getshortvacation(w: World):
    ...
    return w.scene("小さな休暇を得る",
            ...
            inside.look("普段なら夏休みにたっぷりと休養を取って精力に満ち溢れているところだが、",
                "$adonisの急なプラン変更によりそれが潰れ、結局夏間も毎日しっかり時間いっぱいまでモニタに向かっていた",
...
def sc_gototrip(w: World):
    ...
    return w.scene("旅行に行こう",
            nocht.be("その日は午後四時に解散となり、$Sはいつもの$on_cafebarのカウンターに座っていた", "&"),
            ...
            _.do("$CSの言葉が耳に入らなかったのか、$Sはツマミに頼んだ$makkaraをフォークで突き刺して齧る"),
            mirei.talk("はいお待ち"),
            ...
            _.do("そこまで言うと、残りの$makkaraを無理矢理に口に突っ込み、席を立った"),
            nocht.talk("おい"),
            ...
            asahi.voice("日本で見える場所もあると聞いているけれど、特別それを観測する為に出かけようとは思わないわ",
                "研究をしている方がずっと楽しいもの"),
            nocht.think("――君は本当に仕事好きだね。日本人はみんなそうなのか？"),
