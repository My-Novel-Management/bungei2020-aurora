...
def sc_delete_and_message(w: World):
    ...
    return w.scene("削除とメッセージ",
            ...
            _.think("ただのデータでしかない"),
            _.think("そう思い込もうとした側から、$Sは画像化した彼を呼び出していた"),
...
def sc_stop_del(w: World):
    ...
    return w.scene("削除の停止を",
            ...
            _.explain("そこは会社のビルを出たすぐの、交差点だ",
                ...
                "それなのに彼だけは動いていた", "そんな処理はあり得ない", "どういうバグだろう、といつもの$Sなら考えるはずなのに、",
            ...
            _.think("何の飾り気もない単純な言葉がこれほどにも相応しいとは思わなかった",
                    ...
                    "何度も繰り返し$Sは「綺麗」と口にした"),
            asahi.talk("$nocht、$me……$meも、同じ気持ちだ"),
            _.do("彼の世界は既に全ての建物は消え去り、彼と信号機と、横断歩道のしましま、それにどんな計算結果としてそこに現れているのか分からない緑から赤にグラデーションするオーロラだけに成り果てていた",
                    "もう間に合わないかも知れない",
                    "そう感じつつも$Sはキーボードを叩く"),
            ...
            _.do("$Sは何とか処理を止めようと物理的に破壊することを考え、"),
            _.do("それを目にして、$Sは端末の割り込み操作を行う",
                "データの削除を止めるためだ"),
            asahi.talk("待ってて。今、助けるから",
                "今までのように$meがあなたを！"),
            _.do("だが隣室に入ってプラグを引き抜いて回っても量子コンピュータの可動音は止まらず、それどころか室内で警告灯が光り始め、",
                    "無機質なアナウンスが響いた"),
